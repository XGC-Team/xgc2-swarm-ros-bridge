...
This repository is the upstream ZeroMQ `bridge_node`, packaged for Melodic and
Noetic. The job is to keep that ZMQ path stable. There is no second protocol
and no Zenoh stack in this package.
